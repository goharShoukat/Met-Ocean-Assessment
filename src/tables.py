...
def tables_monthly_summary(df, variable1, variable2, variable3, units, Coordinates, date_range, direc):
    #input
    ...
    plt.close()
'''
def tables_yearly_summary(df, years, variable1, variable2, variable3, units, Coordinates, date_range, direc):
            #input
    #df : pd.DataFrame : df with all the columns intact, read from the cache file generated. 
    #years : np.ndarray : speficifies the year range. one single figure cant accomodate all the values
    ...
    yearly= np.array([years, yearly_mean[variable1], yearly_min[variable1], yearly_max[variable1], yearly_mean[variable2], yearly_min[variable2], yearly_max[variable2], yearly_mean[variable3], yearly_min[variable3], yearly_max[variable3]],dtype=object).T
